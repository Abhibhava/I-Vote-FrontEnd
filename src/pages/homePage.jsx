  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-blue-50 to-indigo-100">
      ...
      <footer className="w-full py-4 bg-white text-center text-gray-600">
        <p>Created by <Link to={"https://github.com/pragya2003"} className="text-indigo-600 hover:text-indigo-800 transition duration-200 ease-in-out">Pragya Mittal</Link></p>
      </footer>
    </div>
  );
}
